...
最新真实状态见 PROJECT_STATUS.md。目前已有185条原创种子、36题独立Benchmark和训练/评测工具；已在4GB完成Rule、Strategy、Tactics三阶段Adapter及完整Base基线；同协议36题Adapter比较已完成，参考动作2/36→0/36，未通过能力验收。23条dev诊断已保存，v0.2-core完整86条已审核冻结，消息与Tokenizer检查通过（525～791 tokens，三阶段正式训练已完成）；视频池完全隔离，正在推进36题同协议比较，尚不能宣布修复有效；不宣称专项能力提升。
